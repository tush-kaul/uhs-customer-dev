...
export default function ServiceWizard({
  ...
  const selectedSubservice = subServices.find((s: any) => s.id === subService);
    ...
    if (currentStep < steps.length - 1) {
      ...
      if (type === "new" && currentStep === 0) {
        try {
          ...
          const hasSameLocationBooking = checkExistingBooking(formValues);
          if (
      ...
      if (
        ...
        if (canProceed) {
          try {
            console.log("Fetching bundles for", frequency, startDate);
            await fetchBundles(frequency as string, startDate as Date);
        ...
        component: (
          <LocationStep
            ...
            onServiceChange={(value) => {
              ...
              form.setValue("subService", "", { shouldValidate: true });
            }}
            onSubServiceChange={(value) => {
              form.setValue("subService", value, { shouldValidate: true });
            }}
          />
        ),
      },
              ...
              months
                ? new Date(
                    new Date(bookingData?.end_date || new Date()).setMonth(
                      new Date(bookingData?.end_date || new Date()).getMonth() +
                        months
                    )
                  )
                : undefined
        ...
        <DialogContent
          ...
          <DialogHeader>
            <DialogTitle className='flex items-center'>
              <span>
                {type === "new" ? "Book New Service" : "Renew Service"}
              </span>
            ...
            <div className='space-y-6'>
              ...
              <div className='flex justify-between items-center gap-2 pt-4 border-t'>
                ...
                <Button
                  ...
                  variant='outline'
                  onClick={handleBack}
                  disabled={currentStep === 0 || loading.confirmBooking}
                  ...
                  {((type === "new" && currentStep === 3) ||
                    ...
                    !blockId && (
                      <Button
                        ...
                        disabled={
                          !isStepValid() || loading.blockingSlot || slotsBlocked
                        }
