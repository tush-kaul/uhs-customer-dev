...
const DataTable = () => {
  ...
  const filteredBookings = useMemo(() => {
    return bookings.filter((booking) => {
      ...
      const matchesProperty =
        selectedProperty === "all" || bookingPropertyName === selectedProperty;
      ...
      <>
        <TableRow
          ...
          <TableCell className='py-4 w-1/5'>
            <div className='flex items-center gap-3'>
              <div className='flex-shrink-0'>
                <Image
                  src={`/icons/${
                    ImagePathSetting[item?.service_name] || "residential"
                  }.svg`}
          ...
          <TableCell className='py-4 w-1/12'>
            <p className='break-words'>{item.apart_type || "N/A"}</p>
          </TableCell>
          <TableCell className='py-4 w-1/12'>
                    ...
                    {item.team_members && item.team_members.length > 0 && (
                      <div>
                        ...
                        <ul className='pl-4 mt-1'>
                          {item.team_members.map((member: any, idx: number) => (
      ...
      <div className='p-4 bg-gray-50 rounded-b-lg border-t border-gray-200'>
        <div className='space-y-4'>
          <div>
            ...
            <div className='space-y-1 text-sm'>
              <p>
                <span className='text-gray-500'>Property:</span> {propertyName}
              </p>
              <p>
                <span className='text-gray-500'>Apartment:</span>{" "}
                {item.apartment_number || "N/A"}
          ...
          <div className='grid grid-cols-2 gap-2 mb-3'>
            ...
            <div>
              ...
              <div className='flex flex-wrap gap-2 mt-1'>
                ...
                {item.status === "upcoming" && item.is_rescheduled === true && (
                  <span className='px-2 py-0.5 inline-block rounded-full text-xs text-center bg-purple-200 text-purple-800'>
                    rescheduled
                  </span>
                )}
              </div>
  ...
  return (
    <div className='w-full'>
      ...
      {isMobile ? (
        <div className='space-y-4'>
          {dataLoading ? (
            ...
            filteredBookings.map((item: any) => (
              <EnhancedBookingCard key={item.id} item={item} />
            ))
          )}
        </div>
      ) : (
      ...
      {!dataLoading && filteredBookings.length === 0 && bookings.length > 0 && (
        <div className='py-8 text-center bg-gray-50 rounded-lg'>
          <div className='max-w-md mx-auto'>
            ...
            <p className='text-gray-500 mb-4'>
              No bookings match your current filter criteria. Try adjusting your
              filters.
            </p>
